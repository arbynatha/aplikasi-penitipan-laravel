...
<head>
    ...
    <link href="{{ asset('asset/css/styleprint.css') }}" rel="stylesheet">
        ...
        <center>
            <div class="page-404 animated flipInX">
                <div id="print-karcis" class="print-area" style="color : #2280c2;">
                    <img src="{{ asset('asset/img/logo.png') }}" style="width: 10%">
                    <h2 style="font-weight:bold; color: #f36f5b ;margin-top: -4px;">Kode Titip Anda</h2>
                    <h1 style="font-size: 70pt; font-weight: bold; color: #029688; margin-top: -10px;">{{ $titip->kode }}</h1>
                    <h3 style="margin-top: -10px;color: #029688">{{ $titip->nama_pemilik }}</h3>
                    <form action="{{ route('print-proses') }}" method="post">
                        @csrf
